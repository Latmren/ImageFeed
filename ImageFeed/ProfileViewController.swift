...
final class ProfileViewController: UIViewController {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            userPicView.topAnchor.constraint(
                equalTo: view.safeAreaLayoutGuide.topAnchor,
                constant: 32
            ),
            userPicView.leadingAnchor.constraint(
                equalTo: view.safeAreaLayoutGuide.leadingAnchor,
                constant: 16
            ),

            userNameLabel.topAnchor.constraint(
                equalTo: userPicView.bottomAnchor,
                constant: 8
            ),
            userNameLabel.leadingAnchor.constraint(
                equalTo: userPicView.leadingAnchor
            ),

            userLoginNameLabel.topAnchor.constraint(
                equalTo: userNameLabel.bottomAnchor,
                constant: 8
            ),
            userLoginNameLabel.leadingAnchor.constraint(
                equalTo: userNameLabel.leadingAnchor
            ),

            userDescriptionLabel.topAnchor.constraint(
                equalTo: userLoginNameLabel.bottomAnchor,
                constant: 8
            ),
            ...
            logoutButton.centerYAnchor.constraint(
                equalTo: userPicView.centerYAnchor
            ),
